import 'package:fitness_tracker/app/constants/hive_table_constant.dart';
import 'package:fitness_tracker/features/auth/data/model/auth_hive_model.dart';
...
class HiveService {
  static Future<void> init() async {
    ...
    var path = '${directory.path}gym_app.db';
